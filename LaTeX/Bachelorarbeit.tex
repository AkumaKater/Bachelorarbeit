...
Die Feature Map wird dann zurück gegeben. Dies muss allerding nicht nur für jedes bild, sondern auch für jeden Filter gemacht werden. Dazu schreiben wir die methode "convolutionForwardPass". Diese benötigt eine Liste an input Bildern, und gibt eine Liste an Feature Maps zurück:
