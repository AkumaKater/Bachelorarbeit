...
class PacmanEnv(gym.Env):
    ...
    def __init__(self):  # TODO set to 4
        ...
        # a 2D array of widht x height of all possible tiles of the gameworld, based on PacmanAgent.tileTypes
        # The index of each tileType will represent the resprective tileType, e.G. 0 = empty, 1 = wall etc.
    ...
    def step(self, action):
        ...
        gameover = pacmanEaten or gameover
        ...
        if self.agentType == "Ghost":
            ...
            if gameover and self.remainingDots > 0:
                reward = 1
            else:
                reward = 1 - reward
        ...
        if PacmanAgent.usingSimpleObservations:
            return self.view, reward, gameover, {}
        else:
            return observations, reward, gameover, {}
