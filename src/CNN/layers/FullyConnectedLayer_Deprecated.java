...
public class FullyConnectedLayer_Deprecated extends Layer{
    ...
    public FullyConnectedLayer_Deprecated(int numInputNodes, int numOutputNodes) {
    ...
    public double[] CalculateHiddenLayerNodeValues(double[] nodeValues) {
        FullyConnectedLayer_Deprecated oldLayer = (FullyConnectedLayer_Deprecated)nextLayer;
